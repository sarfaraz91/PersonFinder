...
//    public static final String BASE_URL = "http://206.189.229.45";
public static final String BASE_URL = "http://demo.theembroider.com";
    ...
    public static final String LOGIN = "/api/login?type=marketer";
    public static final String REGISTER = "/api/register/user";
